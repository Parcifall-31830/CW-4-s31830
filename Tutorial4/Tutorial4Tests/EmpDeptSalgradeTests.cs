...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = emps.FindAll(e=>e.Job=="SALESMAN");
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        List<Emp> result = emps.FindAll(e=>e.DeptNo==30).OrderByDescending(e=>e.Sal).ToList(); 
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.FindAll(e=> depts.Any(d=>d.Loc=="CHICAGO"&&d.DeptNo==e.DeptNo)); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm != null).Select(r => new { r.EName, r.Comm }).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e=>e.DeptNo).Select(r=> new{DeptNo=r.Key,AvgSal= r.Average(e=>e.Sal)}).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal >emps.Where(e1 => e1.DeptNo == e.DeptNo).Average(e => e.Sal)).Select(e=>e.EName).ToList();
